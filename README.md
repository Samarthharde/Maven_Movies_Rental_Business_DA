...
# Tools & Library Used
<img src="SQL_image.jpg" alt="SQL_image.jpg" width="200"/> &nbsp;
...
<img src="./ImagesOutput/Email.png" alt="Email.png" width="400"/> &nbsp;


2. "What is the total number of movies in the inventory that are available for rent at the lowest rental rate of $0.99?"

<img src="./ImagesOutput/CHEAPEST_RENTAL.png" alt="CHEAPEST_RENTAL.png" width="200"/> &nbsp;


3. "How can we categorize all movies based on their rental rates and determine the count of movies in each category?"

<img src="./ImagesOutput/TOTAL_NO_OF_MOVIES.png" alt="TOTAL_NO_OF_MOVIES.png" width="400"/> &nbsp;
